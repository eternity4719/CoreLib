 ...
 *
 * <p>本插件不包含任何业务逻辑，唯一作用是把 CoreLib 所需的第三方库
 ...
 *
 * <p>好处：CoreLib 主 jar 只含自身代码（几十 KB），日常迭代上传飞快；
 * 这些体积较大、更新频率低的依赖只随本插件部署一次。
 */
public final class CoreLibRuntime extends JavaPlugin {

    @Override
    public void onEnable() {
        getLogger().info("CoreLibRuntime 已加载，运行时依赖就绪。");
    }
}
